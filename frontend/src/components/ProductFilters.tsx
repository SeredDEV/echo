    ...
    return (
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6 overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b-2 border-gray-100">
                <h3 className="text-xl font-bold text-[#0FA6D1]">
                    Filtros
                </h3>
            ...
            <div className="mb-6">
                ...
                <div className="space-y-3">
                    {categorias.map((categoria) => (
                        <label key={categoria} className="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-[#0FA6D1]/5 transition-all">
                            <input
                                type="checkbox"
            ...
            <div className="mb-6">
                ...
                <div className="space-y-2 max-h-56 overflow-y-auto pr-2 custom-scrollbar">
                    {marcas.map((marca) => (
                        <label key={marca} className="flex items-center gap-3 cursor-pointer group p-2 rounded-lg hover:bg-[#0FA6D1]/5 transition-all">
                            <input
                                type="checkbox"
