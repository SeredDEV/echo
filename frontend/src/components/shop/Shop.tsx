      ...
      <div className="container mx-auto px-4 py-12">
              ...
              <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-1 md:hidden">
                <button
                  ...
                  className={`p-2 rounded-md transition-all ${
                    viewMode === "grid-2"
                      ? "bg-white shadow-sm text-[#0FA6D1]"
                      : "text-gray-600"
                  }`}
                  title="Cuadrícula"
                >
        ...
        <div className="flex gap-8">
          ...
          {showFilters && (
            ...
            >
              <div
                className="absolute right-0 top-0 bottom-0 w-full max-w-md bg-white overflow-y-auto animate-slide-left shadow-2xl"
                        ...
                        (_, i) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-10 h-10 rounded-lg font-semibold transition-all text-sm shadow-sm ${
                                currentPage === page
