          ...
          <div className="lg:col-span-2 space-y-4">
            {items.map((item) => (
              <div
                ...
                className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row gap-4 items-start sm:items-center group transition-all hover:shadow-md"
              >
                {/* Product Image */}
                ...
                <div className="flex-1 w-full min-w-0">
                  <div className="flex flex-col sm:flex-row justify-between items-start gap-2 mb-3">
                    <div>
                      <h3 className="font-bold text-gray-900 text-lg leading-tight line-clamp-2 pr-0 sm:pr-4">
                        {item.nombre}
                      </h3>
                          ...
                          <span className="flex items-center gap-1 bg-gray-100 px-2 py-0.5 rounded text-xs">
                            <div
                              className={`w-2 h-2 rounded-full ${
                                item.selectedColor === "Negro"
                                  ? "bg-black"
                                  : item.selectedColor === "Blanco"
                                  ? "bg-white border border-gray-300"
                                  : item.selectedColor === "Azul"
                                  ? "bg-blue-600"
                                  : "bg-gray-400"
                              }`}
                            ></div>
            ...
            <div className="bg-white p-5 sm:p-6 md:p-8 rounded-3xl shadow-lg border border-gray-100 sticky top-24">
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="border-t border-gray-100 pt-4 flex justify-between items-center">
                  ...
                  <span className="font-bold text-2xl text-[#0FA6D1]">
