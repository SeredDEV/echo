                        ...
                        <div className="hidden lg:flex items-center gap-1">
                                ...
                                <div className="absolute left-0 mt-2 w-[400px] bg-white rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-100">
                                    <div className="p-6">
                                        <div className="grid grid-cols-2 gap-4">
                                            <a href="tienda.html?categoria=altavoces" className="flex flex-col items-center p-4 rounded-lg hover:bg-primary-50 transition-all group/item">
                            ...
                            <div className="group relative">
                                ...
                                <div className="absolute left-0 mt-2 w-[400px] bg-white rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-100">
                                    <div className="p-6">
                                        <div className="grid grid-cols-2 gap-4">
                                            <a href="#streaming" className="flex flex-col items-center p-4 rounded-lg hover:bg-primary-50 transition-all group/item">
                                ...
                                <div className="absolute left-0 mt-2 w-[500px] bg-white rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-100">
                                    <div className="p-6">
                                        <div className="grid grid-cols-3 gap-3">
                                            <a href="tienda.html?categoria=accesorios" className="flex flex-col items-center p-3 rounded-lg hover:bg-primary-50 transition-all group/item">
