        ...
        <>
            ...
            <header className="bg-white shadow-md sticky top-0 z-50 border-b border-gray-100">
                <nav className="container mx-auto px-4 py-4">
                    ...
                    {/* Mobile Menu */}
                    {isMenuOpen && (
                        <div className="lg:hidden mt-6 pb-6 space-y-2 animate-slide-up">
                            <a href="index.html" className="flex items-center gap-4 px-5 py-4 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
                            ...
                            <a href="#altavoces" className="flex items-center gap-4 px-5 py-4 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
                                <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" />
                                    </svg>
                                </div>
                                <span className="text-base">Altavoces Inteligentes</span>
                            </a>
                            <a href="#streaming" className="flex items-center gap-4 px-5 py-4 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
                                <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="text-base">Dispositivos Streaming</span>
                            </a>
                            <a href="#accesorios" className="flex items-center gap-4 px-5 py-4 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
                                <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                    </svg>
                                </div>
                                <span className="text-base">Accesorios Inteligentes</span>
                            </a>
                            <a href="about.html" className="flex items-center gap-4 px-5 py-4 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
                                <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="contacto.html" className="flex items-center gap-4 px-5 py-4 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-2xl transition-all duration-300 shadow-sm hover:shadow-md">
                                <div className="w-10 h-10 bg-primary-50 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
