                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden lg:flex items-center gap-1">
                            ...
                            <div className="group relative">
                                <a href="tienda.html?categoria=altavoces" className="flex items-center gap-1 px-4 py-2 text-gray-700 font-medium transition-all duration-300">
                                    ...
                                    <div className="p-6">
                                        <div className="grid grid-cols-2 gap-4">
                                            <a href="tienda.html?categoria=altavoces&marca=Amazon" className="flex flex-col items-center p-4 rounded-lg hover:bg-primary-50 transition-all group/item">
                                                <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-3 group-hover/item:scale-110 transition-transform">
                                            ...
                                            <a href="tienda.html?categoria=altavoces&marca=Google" className="flex flex-col items-center p-4 rounded-lg hover:bg-primary-50 transition-all group/item">
                                                ...
                                                <div className="font-semibold text-gray-900 text-center">Google Home</div>
                                                <div className="text-xs text-gray-500 text-center mt-1">Nest Audio, Nest Mini</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="group relative">
                                <a href="tienda.html?categoria=streaming" className="flex items-center gap-1 px-4 py-2 text-gray-700 font-medium transition-all duration-300">
                                    ...
                                    <div className="p-6">
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <a href="tienda.html?categoria=streaming&marca=Google" className="flex flex-col items-center p-4 rounded-lg hover:bg-primary-50 transition-all group/item">
                                                <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-green-500 rounded-2xl flex items-center justify-center mb-3 group-hover/item:scale-110 transition-transform">
                                                    <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                        <path d="M21 3H3c-1.11 0-2 .89-2 2v12c0 1.1.89 2 2 2h5v2h8v-2h5c1.1 0 1.99-.9 1.99-2L23 5c0-1.11-.9-2-2-2zm0 14H3V5h18v12zm-5-6l-7 4V7z" />
                                                    </svg>
                                                </div>
                                                <div className="font-semibold text-gray-900 text-center">Google Chromecast</div>
                                                <div className="text-xs text-gray-500 text-center mt-1">Chromecast con Google TV</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="group relative">
                                <a href="tienda.html?categoria=accesorios" className="flex items-center gap-1 px-4 py-2 text-gray-700 font-medium transition-all duration-300">
                                    ...
                                    <div className="p-6">
                                        <div className="grid grid-cols-3 gap-3">
                                            ...
                                            <a href="tienda.html?categoria=accesorios&subcategoria=Apagadores" className="flex flex-col items-center p-3 rounded-lg hover:bg-primary-50 transition-all group/item">
                                                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mb-2 group-hover/item:scale-110 transition-transform">
                                                    <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <a href="tienda.html?categoria=accesorios&subcategoria=Cintas LED" className="flex flex-col items-center p-3 rounded-lg hover:bg-primary-50 transition-all group/item">
                                                <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl flex items-center justify-center mb-2 group-hover/item:scale-110 transition-transform">
                                            ...
                                            <a href="tienda.html?categoria=accesorios&subcategoria=Cámaras" className="flex flex-col items-center p-3 rounded-lg hover:bg-primary-50 transition-all group/item">
                                                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center mb-2 group-hover/item:scale-110 transition-transform">
                                                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                                    </svg>
                                                </div>
                                                <div className="font-semibold text-gray-900 text-center text-sm">Cámaras</div>
                                                <div className="text-xs text-gray-500 text-center">Seguridad</div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="lg:hidden mt-4 pb-4 animate-slide-up">
                            {!mobileSubmenu ? (
                                <div className="space-y-1.5">
                                    ...
                                    <button onClick={() => setMobileSubmenu('altavoces')} className="w-full flex items-center justify-between px-4 py-3 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-xl transition-all duration-300 shadow-sm hover:shadow-md">
                                    ...
                                    <button onClick={() => setMobileSubmenu('streaming')} className="w-full flex items-center justify-between px-4 py-3 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-xl transition-all duration-300 shadow-sm hover:shadow-md">
                                        <div className="flex items-center gap-3">
                                            <div className="w-9 h-9 bg-primary-50 rounded-lg flex items-center justify-center flex-shrink-0">
                                                <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button onClick={() => setMobileSubmenu('accesorios')} className="w-full flex items-center justify-between px-4 py-3 text-gray-800 hover:text-primary-600 bg-white hover:bg-gray-50 font-medium rounded-xl transition-all duration-300 shadow-sm hover:shadow-md">
                                        <div className="flex items-center gap-3">
                                            <div className="w-9 h-9 bg-primary-50 rounded-lg flex items-center justify-center flex-shrink-0">
                                                <svg className="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="space-y-3">
                                    {/* Back Button */}
                                    <button onClick={() => setMobileSubmenu(null)} className="flex items-center gap-2 px-4 py-2 text-gray-700 hover:text-primary-600 font-medium transition-colors">
                                    ...
                                    <div className="px-4 py-2 border-b border-gray-200">
                                        <h3 className="text-lg font-bold text-gray-900">
                                            {mobileSubmenu === 'altavoces' && 'Altavoces Inteligentes'}
                                            {mobileSubmenu === 'streaming' && 'Dispositivos Streaming'}
                                            {mobileSubmenu === 'accesorios' && 'Accesorios Inteligentes'}
                                        </h3>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        {mobileSubmenu === 'altavoces' && (
                                            <>
                                                <a href="tienda.html?categoria=altavoces&marca=Amazon" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Amazon Alexa</div>
                                                        <div className="text-xs text-gray-500">Echo, Echo Dot, Echo Show</div>
                                                    </div>
                                                </a>
                                                <a href="tienda.html?categoria=altavoces&marca=Google" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Google Home</div>
                                        ...
                                        {mobileSubmenu === 'streaming' && (
                                            <>
                                                <a href="tienda.html?categoria=streaming&marca=Amazon" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Amazon Fire TV</div>
                                                        <div className="text-xs text-gray-500">Fire TV Stick, Fire TV Cube</div>
                                                    </div>
                                                </a>
                                                <a href="tienda.html?categoria=streaming&marca=Google" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Google Chromecast</div>
                                        ...
                                        {mobileSubmenu === 'accesorios' && (
                                            <>
                                                <a href="tienda.html?categoria=accesorios&subcategoria=Bombillos" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Bombillos Inteligentes</div>
                                                        <div className="text-xs text-gray-500">LED RGB, Blanco ajustable</div>
                                                    </div>
                                                </a>
                                                <a href="tienda.html?categoria=accesorios&subcategoria=Tomacorrientes" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Tomacorrientes</div>
                                                        <div className="text-xs text-gray-500">Control remoto, WiFi</div>
                                                    </div>
                                                </a>
                                                <a href="tienda.html?categoria=accesorios&subcategoria=Apagadores" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Apagadores Inteligentes</div>
                                                        <div className="text-xs text-gray-500">Touch, Control por voz</div>
                                                    </div>
                                                </a>
                                                <a href="tienda.html?categoria=accesorios&subcategoria=Cintas LED" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Cintas LED</div>
                                                        <div className="text-xs text-gray-500">RGB, Música sincronizada</div>
                                                    </div>
                                                </a>
                                                <a href="tienda.html?categoria=accesorios&subcategoria=Cerraduras" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Cerraduras Inteligentes</div>
                                                        <div className="text-xs text-gray-500">Huella, PIN, App</div>
                                                    </div>
                                                </a>
                                                <a href="tienda.html?categoria=accesorios&subcategoria=Cámaras" className="flex items-center gap-4 px-4 py-3 bg-white hover:bg-primary-50 rounded-xl transition-all shadow-sm">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900">Cámaras</div>
